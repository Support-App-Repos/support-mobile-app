...
const getBaseURL = () => {
  ...
  if (Platform.OS === 'android') {
    baseURL = API_BASE_URL_ANDROID || API_BASE_URL || 'http://10.85.190.75:3000/api';
  } else {
    baseURL = API_BASE_URL_IOS || API_BASE_URL || 'http://10.85.190.75:3000/api';
  }
...
export {
  ...
  serializeAmenityIds,
  type PropertyAmenityId,
  type ParsedAmenityToken,
